...
class UBCNotificationManager:
    ...
    def send_notifications(self, available_courts: Dict[str, List[Dict]]) -> bool:
        ...
        try:
            ...
            self.logger.info(f"Sending notifications for {total_courts} available UBC courts")
    ...
    def _send_sms_notification(self, available_courts: Dict[str, List[Dict]]) -> bool:
        ...
        try:
            ...
            self.logger.info(f"UBC SMS notification sent successfully! SID: {message_obj.sid}")
            return True
