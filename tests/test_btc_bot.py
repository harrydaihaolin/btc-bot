...
class TestBTCTennisBot(unittest.TestCase):
    """Test cases for BTC Tennis Bot"""

    def setUp(self):
        """Set up test fixtures"""
        with patch('btc_bot.BTCConfig') as mock_config, \
             patch('btc_bot.BTCMonitor') as mock_monitor, \
             patch('btc_bot.BTCNotificationManager') as mock_notifications, \
             patch('btc_bot.logging.basicConfig'):
    ...
    def test_run_timeslot_monitoring(self, mock_sleep):
        ...
        with patch('btc_bot.input') as mock_input:
