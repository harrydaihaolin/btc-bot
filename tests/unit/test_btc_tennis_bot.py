...
from btc_tennis_bot import setup_credentials, run_single_scan, run_continuous_monitoring, main
...
class TestBTCTennisBot:
    ...
    def test_setup_credentials_interactive(self, mock_getpass, mock_input, mock_config_class):
    ...
    @patch('btc_tennis_bot.input')
    @patch('btc_tennis_bot.getpass.getpass')
    def test_setup_credentials_interactive_empty_notification_email(self, mock_getpass, mock_input, mock_config_class):
        ...
        assert credentials['username'] == 'test@example.com'
        assert credentials['notification_email'] == 'test@example.com'  # Should default to username
        assert credentials['phone_number'] == '1234567890'
        assert credentials['gmail_app_email'] == 'test@gmail.com'
        assert credentials['gmail_app_password'] == 'apppass'
    ...
    @patch('btc_tennis_bot.input')
    @patch('btc_tennis_bot.getpass.getpass')
    def test_setup_credentials_interactive_empty_gmail_app_email(self, mock_getpass, mock_input, mock_config_class):
        ...
        assert credentials['phone_number'] == '1234567890'
        assert credentials['gmail_app_email'] == 'notify@example.com'  # Should default to notification_email
        assert credentials['gmail_app_password'] == 'apppass'
    ...
    @patch('btc_tennis_bot.CourtMonitor')
    @patch('btc_tennis_bot.NotificationManager')
    def test_run_single_scan_login_failed(self, mock_notification_class, mock_monitor_class):
    ...
    @patch('btc_tennis_bot.CourtMonitor')
    @patch('btc_tennis_bot.NotificationManager')
    def test_run_single_scan_navigation_failed(self, mock_notification_class, mock_monitor_class):
    ...
    @patch('btc_tennis_bot.CourtMonitor')
    @patch('btc_tennis_bot.NotificationManager')
    def test_run_single_scan_exception(self, mock_notification_class, mock_monitor_class):
    ...
    @patch('btc_tennis_bot.run_single_scan')
    @patch('btc_tennis_bot.time.sleep')
    def test_run_continuous_monitoring_no_courts(self, mock_sleep, mock_run_single_scan):
    ...
    @patch('btc_tennis_bot.run_single_scan')
    @patch('btc_tennis_bot.time.sleep')
    def test_run_continuous_monitoring_exception(self, mock_sleep, mock_run_single_scan):
    ...
    @patch('btc_tennis_bot.run_single_scan')
    @patch('btc_tennis_bot.time.sleep')
    def test_run_continuous_monitoring_max_attempts(self, mock_sleep, mock_run_single_scan):
    ...
    @patch('btc_tennis_bot.run_single_scan')
    def test_main_success(self, mock_run_single_scan, mock_setup_credentials, mock_config_class, mock_monitor_class, mock_notification_class):
        ...
        mock_courts = {
            '2024-01-01': [
                {'time': '10:00 AM', 'text': 'Book 10:00 am as 48hr', 'court_number': '1'}
            ]
        }
        mock_run_single_scan.return_value = mock_courts
    ...
    @patch('btc_tennis_bot.setup_credentials')
    @patch('btc_tennis_bot.run_single_scan')
    def test_main_no_courts(self, mock_run_single_scan, mock_setup_credentials, mock_config_class, mock_monitor_class, mock_notification_class):
    ...
    def test_main_continuous_monitoring(self, mock_run_continuous_monitoring, mock_setup_credentials, mock_config_class, mock_monitor_class, mock_notification_class):
