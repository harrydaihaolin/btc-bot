...
class TestUBCMonitor(unittest.TestCase):
    ...
    def test_login_success(self, mock_ec, mock_wait):
        ...
        mock_driver.find_element.return_value = MagicMock()  # password field and login button
    ...
    def test_login_failure(self, mock_wait):
        """Test failed login"""
        mock_driver = MagicMock()
        mock_driver.current_url = "https://portal.recreation.ubc.ca/index.php?r=public/index"
        self.monitor.driver = mock_driver
    ...
    def test_check_login_success_redirect(self):
        ...
        mock_driver = MagicMock()
        mock_driver.current_url = "https://www.ubc.ca/search/refine/?q=&label=Search+UBC"
        self.monitor.driver = mock_driver
    ...
    def test_scan_available_courts_with_elements(self):
        ...
        with patch.object(self.monitor, '_extract_ubc_court_info', return_value={
            'court_name': 'Court 01',
            'status': 'Available',
            'date': '2025-10-26',
    ...
    def test_get_court_unique_identifier_empty_values(self):
        ...
        self.assertNotEqual(result.count(''), 0)  # There might be empty strings in the sorted result
